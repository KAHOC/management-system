	  ...
	  $("#send").click(function(){
		  $('[name=chkInfo]:checkbox').each(function() {
		   ...
		   $("#del").click(function(){
		    	...
		    	$(this).prop("href","Tb_lessonServlet?f=del&id="+chkValue);
		    	return true;
		    });
	  });
    	...
    	<div class="defaultTab-T"><h5>&nbsp;&nbsp;&nbsp;当前位置：管理员信息管理</h5></div>
						<div class="defaultTab-T">
							<table border="0" cellspacing="0" cellpadding="0" class="defaultTable">
								<tbody><tr><th class="t_1">管理员ID</th><th class="t_2">管理员用户名</th><th class="t_4">加入时间</th><th class="t_4">选项</th></tr>
							</tbody></table>
						</div>
						<table border="0" cellspacing="0" cellpadding="0" class="defaultTable defaultTable2">
							<tbody>
							<c:forEach items="${leslist}" var="leslist">
							<tr>
								<td class="t_1">${leslist.id }</td>
								<td class="t_2">${leslist.name}</td>
								<td class="t_4"><a href="#">${leslist.joinTime}</a></td>
								<td class="t_4"><input type="checkbox" name="chkInfo" value="${leslist.id}" ></td>
